...
public class SpecialIndexGenerator implements IndicesGenerator
{
	...
	private int storeTopSection(int[] indices, int rowLength, int vertexLength)
	{
		int pointer = 0;
	...
	private int storeSecondLastLine(int[] indices, int pointer, int rowLength, int vertexLength)
	{
	...
	private int storeLastLine(int[] indices, int pointer, int rowLength, int vertexLength)
	{
	...
	private int storeQuad(int topLeft, int topRight, int bottomLeft, int bottomRight, int[] indices, int pointer,
			boolean rightHanded)
	{
	...
	private int storeLastRowQuad(int topLeft, int topRight, int bottomLeft, int bottomRight, int[] indices, int pointer,
			boolean rightHanded)
	{
		pointer = storeLeftTriangle(topLeft, topRight, bottomLeft, bottomRight, indices, pointer, rightHanded);
		indices[pointer++] = bottomRight;
	...
	private int storeLeftTriangle(int topLeft, int topRight, int bottomLeft, int bottomRight, int[] indices, int pointer,
			boolean rightHanded)
	{
